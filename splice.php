...
<html>
  <head>
        ...
        <script src="./splice-src/js/jquery3.js"></script>
         <link rel="stylesheet" href="./splice-src/css/w3.css">
         <link rel="stylesheet" href="./splice-src/css/font-awesome.min.css">
...
.tool_state {
 ...
 #splash {
  width:100%;
  height: 100%;
  background: linear-gradient(rgb(36, 40, 45),rgba(20, 27, 35, 0.94), rgba(0, 0, 0, 0.94)), url('./splice-src/img/splash.gif') fixed center center;
      ...
      <?php @readfile($init_file);?>
        ...
        <div class="split-pane fixed-left" style="display:block;" id="editor_panel">
            ...
            <div class="w3-bar top-bar dark-border-bottom">
                ...
                <a class="w3-text-white w3-bar-item w3-right w3-btn" title="file status"><i id="indicator" class="fa fa-circle"></i></a>
            </div>
             <!--editor-->
               <div id="editor" onkeyup="file_status('edit')"></div>
             <!--filemanager-->
             <div id="file_manager">
...
?>
         <li id="no_matches"><a class="dark-border w3-round w3-padding-small w3-text-grey tool_state"><i class="fa fa-warning w3-text-amber"></i> END OF RESULTS</a></li>
             ...
             <!--dock-->
                <div class="w3-bar bottom-bar dark-border-top dark-border-bottom">
    ...
    <!--all the javascript-->
    <!--scroll bar-->
    <script src="./splice-src/js/perfect-scrollbar.js"></script>
    <link rel="stylesheet" href="./splice-src/css/perfect-scrollbar.css">
    <script>
    ...
    <script src="./splice-src/src/ace.js" type="text/javascript" charset="utf-8"></script>
<script>
    var capp = "editor";
